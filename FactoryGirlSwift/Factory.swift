...
public class Factory {
    ...
    public typealias ObjectBuilder = () -> FactoryBuildable
    ...
    public typealias TemplateDefinition = (Factory) -> ()
    public typealias InstanceDefinition = (Factory) -> ()
    // When defining a collection, the definition is also provided the index.
    public typealias CollectionInstanceDefinition = (Int, Factory) -> ()
    
    public let name: String
    public var entityName: String?
    public var objectBuilder: ObjectBuilder?
    ...
    public func set(propertyName: String, withValue closure: @auto_closure () -> AnyObject) {
        valueDefinitions[propertyName] = FactoryValueDefinition(externalSetter: closure)
    }
    
    public func set(propertyName: String, withFactoryNamed factoryName: String, instanceDefinition: InstanceDefinition? = nil) {
        valueDefinitions[propertyName] = FactoryValueDefinition(factoryName: factoryName, instanceDefinition: instanceDefinition)
    }
    
    public func set(propertyName: String, withCollectionOfFactoriesNamed factoryName: String, count: Int, instanceDefinitions: CollectionInstanceDefinition? = nil) {
    ...
    public func define(factoryName: String, definition: TemplateDefinition) {
